...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public int updateSong(Song data){
        ...
        values.put(String.valueOf(COLUMN_YEAR), data.getYear());
        values.put(String.valueOf(COLUMN_STARS), data.getStars());
    ...
    public ArrayList<Song> getAllSongs() {
        ...
        String[] columns= {COLUMN_ID, COLUMN_TITLE, COLUMN_SINGERS, String.valueOf(COLUMN_YEAR),String.valueOf(COLUMN_STARS)};
